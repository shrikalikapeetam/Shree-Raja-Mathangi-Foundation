  ...
  return (
    ...
    >
      <div className="container text-center items-center sm:items-start sm:text-left gap-6 flex flex-col lg:flex-row sm:gap-7 md:gap-8 lg:gap-9 xl:gap-10">
        <header className="flex max-w-xs items-center sm:items-start  flex-col gap-4">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 m-0 p-0 gap-10">
              ...
              <div className="flex items-center flex-col sm:flex-row gap-4 flex-1">
                {isFilled.image(member.profile_image) && (
                  <PrismicNextImage
                    ...
                    className="max-w-32 sm:max-w-36 md:max-w-40 lg:max-w-44 xl:max-w-48 aspect-square w-full rounded-full object-cover"
                  />
                )}
